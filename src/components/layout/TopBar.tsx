...
const navigationItems = [
  ...
  { href: '/dashboard/werk', icon: Icons.users, label: 'Wie doet Wat', keywords: ['taken', 'verantwoordelijkheden', 'wie doet wat', 'nieuwsbrief'] },
  { href: '/dashboard/werk/overdracht', icon: Icons.fileText, label: 'Overdracht', keywords: ['overdracht', 'waarneming', 'waarnemer', 'afwezig', 'dossier'] },
  ...
  { href: '/dashboard/partners/werk-lodewijk', icon: Icons.briefcase, label: 'Werk Lodewijk', keywords: ['lodewijk', 'extern', 'advocaat', 'van thiel', 'zaken'], roles: ['PARTNER', 'ADMIN'] },
  { href: '/dashboard/werk/lopende-zaken', icon: Icons.briefcase, label: 'Lopende zaken', keywords: ['lopende', 'zaken', 'cases', 'uren'], roles: ['PARTNER', 'ADMIN'] },
...
const mobileMenuItems = [
  ...
  { href: '/dashboard/ontwikkelplannen', icon: Icons.target, label: 'Ontwikkelplannen' },
  ...
  { href: '/dashboard/partners/werk-lodewijk', icon: Icons.briefcase, label: 'Werk Lodewijk', roles: ['PARTNER', 'ADMIN'] },
  { href: '/dashboard/werk/lopende-zaken', icon: Icons.briefcase, label: 'Lopende zaken', roles: ['PARTNER', 'ADMIN'] },
  { href: '/dashboard/financien', icon: Icons.pieChart, label: 'Financiën' },
  { href: '/dashboard/declaraties', icon: Icons.euro, label: 'Declaraties' },
