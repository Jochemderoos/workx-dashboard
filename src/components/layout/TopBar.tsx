...
const navigationItems = [
  ...
  { href: '/dashboard/werk/lopende-zaken', icon: Icons.briefcase, label: 'Lopende zaken', keywords: ['lopende', 'zaken', 'cases', 'uren'] },
...
const mobileMenuItems = [
  ...
  { href: '/dashboard/werk/lopende-zaken', icon: Icons.briefcase, label: 'Lopende zaken' },
